...
export type OpenaiReqestFormValues = z.infer<typeof formSchema>;

interface OpenaiRequestDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (value: z.infer<typeof formSchema>) => void;
  defaultValues?: Partial<OpenaiReqestFormValues>;
}

export const OpenaiRequestDialog = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues = {},
}: OpenaiRequestDialogProps) => {
