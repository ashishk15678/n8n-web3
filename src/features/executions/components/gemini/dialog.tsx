...
export type GeminiReqestFormValues = z.infer<typeof formSchema>;

interface GeminiRequestDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (value: z.infer<typeof formSchema>) => void;
  defaultValues?: Partial<GeminiReqestFormValues>;
}

export const GeminiRequestDialog = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues = {},
}: GeminiRequestDialogProps) => {
